  ...
  return (
    <div className="py-1">
      <button
        ...
        className="flex w-full items-center justify-between rounded-md px-1 py-1 transition-colors hover:bg-border-light"
      ...
      {isOpen && (
        <ul id={`folder-${name}`} className="ml-2 space-y-0" role="list">
          {files.map((file) => (
